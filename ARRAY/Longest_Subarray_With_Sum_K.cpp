...
int findlength(vector<int>&nums,int k)
{
    ...
    for(int i=0;i<nums.size();i++)
    {
        ...
        //Here if we simply update thhe sum in every index without checking it can make error in zero based elements... 
...
int main()
{
    vector<int>nums={1,0,-4,3,1,0}; //test case for above zero elements...
